...
namespace ManInBalaclava.Extensions
{
	...
	{
		public static bool IsBeingArrested(this Player player) => Function.Call<bool>("IS_PLAYER_BEING_ARRESTED");
		...
		public static bool IsWanted(this Player player) => player.WantedLevel > 0;

		public static bool IsUsingMask(this Player player) =>
			Function.Call<int>("GET_CHAR_DRAWABLE_VARIATION", player.Character, 8) == 1;

		private static bool IsUsingGloves(this Player player) =>
			Function.Call<int>("GET_CHAR_DRAWABLE_VARIATION", player.Character, 4) == 1;
